    ...
    <section ref={ref} id="home">
      <div className="flex flex-col lg:flex-row items-center lg:justify-between w-full px-6 lg:px-20 py-12 lg:py-20">
        <div className="lg:w-1/2 text-left">
          ...
          <Link to="/signup">
            <button className="relative overflow-hidden bg-black text-[#00df9a] w-[200px] rounded-md font-bold my-6 mx-auto md:mx-0 py-3 shadow-lg transition-transform duration-300 hover:scale-105 hover:shadow-[#00df9a]/30">
        ...
        <div className="lg:w-1/2 mt-10 lg:mt-0 flex justify-center lg:justify-end items-center lg:ml-10">
          <div className="w-full h-auto rounded-lg shadow-2xl shadow-green-500/20 border-2 border-green-500/50 backdrop-blur-sm transition-transform duration-500 hover:scale-[1.02]">
            <video
              src={Recruiting}
              autoPlay
              loop
